                ...
                {os.length===0 ? (
                  ...
                  return (
                    <tr key={o.id}>
                      ...
                      <td style={{padding:'12px 16px',fontSize:13,fontWeight:700,color:'#EEF2FF',borderBottom:'1px solid rgba(96,165,250,0.05)'}}>{o.cliente_id}</td>
                      <td style={{padding:'12px 16px',fontSize:13,color:'#8899BB',borderBottom:'1px solid rgba(96,165,250,0.05)'}}>{o.tecnico_id||'—'}</td>
